...
musica_de_fundo = pygame.mixer.music.load('audio/10-overworld-bgm.mp3')
...
class personagem(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.som_pulo = pygame.mixer.Sound('audio/pulo_sonic.mp3')
...
class resposta_correta(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect = self.image.get_rect()
        self.rect.topleft = 320, 242  # 300, 242  pos_resp_correta
